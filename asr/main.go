...
const (
	...
	endpointURL           = "https://asr.ilivedata.com/api/v1/speech/recognize"
	endpointHost          = "asr.ilivedata.com"
	endpointPath          = "/api/v1/speech/recognize"
	iso8601DateFormatNoMS = "2006-01-02T15:04:05Z"
)

// Recognize Invoke speech recognize v1 API
func Recognize(audio string, languageCode string, userID string, profanityFilter int) string {
	// UTC Time
