...
const (
	...
	endpointURL           = "https://asr.ilivedata.com/api/v1/speech/recognize/result"
	endpointHost          = "asr.ilivedata.com"
	endpointPath          = "/api/v1/speech/recognize/result"
	iso8601DateFormatNoMS = "2006-01-02T15:04:05Z"
)

// GetResult Invoke speech recognize v1 API
func GetResult(taskID string) string {
	// UTC Time
...
func main() {
	var taskID = "us_0dd60dbb-acc4-4f2f-bada-90e548288d0d_1614852979409"
	GetResult(taskID)
}
